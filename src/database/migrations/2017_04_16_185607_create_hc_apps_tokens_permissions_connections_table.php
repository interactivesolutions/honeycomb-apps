...
/**
 * Class CreateHcAppsTokensPermissionsConnectionsTable
 */
    ...
    public function up(): void
    {
        Schema::create('hc_apps_tokens_permissions_connections', function (Blueprint $table) {
            ...
            $table->string('token_id', 36)
                ->index('fk_hc_apps_tokens_permissions_connections_hc_apps_tokens1_idx');
            $table->string('permission_id', 36)
                ->index('fk_hc_apps_tokens_permissions_connections_hc_acl_permission_idx');
        });
    }
